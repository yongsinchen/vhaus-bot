...
const MODULE_REGISTRY = {
  ...
  DELIVERY: {
    ...
    permissions: [
      ...
      // Delivery Orders (Phase 1 — one SO can ship as many DOs)
      "DELIVERY_ORDER_VIEW", "DELIVERY_ORDER_CREATE", "DELIVERY_ORDER_EDIT",
      "DELIVERY_ORDER_CANCEL", "DELIVERY_ORDER_SCHEDULE", "DELIVERY_ORDER_COMPLETE",
      "DELIVERY_ORDER_OVERRIDE_ARRIVAL",
    ],
  },
  DRIVER: {
    key: "DRIVER",
