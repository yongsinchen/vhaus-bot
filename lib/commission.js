...
//
// Matching is deliberately SUBSTRING and case-insensitive, preserved exactly as
// calculateCommission has always done it: an item earns an incentive if its code
// contains the incentive's product_code, or its name contains the product_name.
// The first matching incentive wins — an item never earns two.
//
...
function matchProductIncentives(orderItems, incentives, excludedIds = []) {
  ...
  for (const item of items) {
    ...
    const match = (incentives || []).find(inc =>
