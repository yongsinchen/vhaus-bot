...
const MODULES = [
  ...
  { key: "DELIVERY", name: "Delivery Schedule", category: "BUSINESS", feature: "DELIVERY", sort: 18, actions: [
    ...
    { key: "DELIVERY_ORDER_VIEW", name: "View Delivery Orders", scope: true },
    { key: "DELIVERY_ORDER_CREATE", name: "Create Delivery Orders" },
    { key: "DELIVERY_ORDER_EDIT", name: "Edit Delivery Orders" },
    { key: "DELIVERY_ORDER_CANCEL", name: "Cancel Delivery Orders" },
    { key: "DELIVERY_ORDER_SCHEDULE", name: "Schedule Delivery Orders" },
    { key: "DELIVERY_ORDER_COMPLETE", name: "Complete Delivery Orders" },
    { key: "DELIVERY_ORDER_OVERRIDE_ARRIVAL", name: "Override Item Arrival Check" },
  ]},
...
const TEMPLATES = {
  ...
  DELIVERY_ORDER_VIEW:        { MASTER: "ALL", DIRECTOR: "ALL", MANAGER: "COMPANY", COMPANY_ADMIN: "BRANCH", SALESMAN: "OWN" },
  DELIVERY_ORDER_CREATE:      { MASTER: true, DIRECTOR: true, MANAGER: true, COMPANY_ADMIN: true },
  DELIVERY_ORDER_EDIT:        { MASTER: true, DIRECTOR: true, MANAGER: true, COMPANY_ADMIN: true },
  DELIVERY_ORDER_CANCEL:      { MASTER: true, DIRECTOR: true, MANAGER: true, COMPANY_ADMIN: true },
  DELIVERY_ORDER_SCHEDULE:    { MASTER: true, DIRECTOR: true, MANAGER: true, COMPANY_ADMIN: true },
  DELIVERY_ORDER_COMPLETE:    { MASTER: true, DIRECTOR: true, MANAGER: true, DRIVER: true },
  DELIVERY_ORDER_OVERRIDE_ARRIVAL: { MASTER: true, DIRECTOR: true, MANAGER: true, COMPANY_ADMIN: true },
  // Driver
